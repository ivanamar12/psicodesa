<div class="modal fade" id="createSecretaria" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      <div class="modal-header" style="background: rgb(0, 204, 204); background: linear-gradient(90deg, rgb(0, 153, 204) 0%, rgb(0, 204, 204) 100%);">
        <h5 class="modal-title" id="exampleModalLabel" >Nuevo Secretaria</h5>
      ...
      <div class="modal-body">
			<form action="/Secretarias" method="POST">
			  ...
			  <div class="col-12 col-lg-3 mb-2">
			    ...
			    <input type="text" class="form-control" name="nombre" aria-describedby="emailHelp" placeholder="Nombres de pila" title="Nombres" required="">
			  </div>
			  <div class="col-12 col-lg-3 mb-2">
			  ...
			  <div class="col-12 col-lg-3 mb-2">
			    <label for="exampleInputEmail1" class="form-label">Grado de instruccion *</label>
			    <input type="text" class="form-control" name="especialidad" required="" aria-describedby="emailHelp" placeholder="grado" title="grado">
			  </div>
			  <div class="col-12 col-lg-3 mb-2">
